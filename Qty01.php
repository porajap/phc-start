...
require 'connect.php';
	...
	if($_POST["Qty"] != "" && $_POST["Price"] != ""){
		...
		header('location:Order_DocNo.php?add=1&sel=0');
	}
...
<body>
	<div class="topnav">
        <a href="Order_DocNo.php"><img src="img/left-blue-arrow.png" width="30px" height="30px" /></a>
	...
	<?php 
		if($_POST["Qty"] != "" && $_POST["Price"] != ""){
			...
			// header('location:Order_DocNo.php?add=1&sel=0');
			echo "<script>
			window.location.href = 'Order_DocNo.php?add=1&sel=0';
			</script>
			";
		}
	?>

	<form action="Qty01.php" method="post">
