                ...
                <div data-demo-html="true">
                    <ul data-role="listview" data-inset="true" data-divider-theme="a">
                        ...
                        ?>
                            <li>
                            	<?php if($AF == 1){ ?>
								<a href="AfterArea.php?HCode=<?php echo $objResult2["Hospital_Code"];?>&HName=<?php echo $objResult2["Hospital_Name"];?>"><h3><?php echo $objResult2["Hospital_Name"];?></h3></a>
                                <?php }else{ ?>
								<a href="InArea.php?HCode=<?php echo $objResult2["Hospital_Code"];?>&HName=<?php echo $objResult2["Hospital_Name"];?>"><h3><?php echo $objResult2["Hospital_Name"];?></h3></a>
                                <?php } ?>    
                            </li>
                        <?php
                        }
                        ?>
                        <li>
                          		<a href="AddHotpital.php"> <h3 align="center" style="color:red" >เพิ่มโรงพยาบาล</h3></a>  
                        </li>
                    </ul>
                </div>    
                </td>
