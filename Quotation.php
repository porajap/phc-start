...
<body>
	<div class="topnav">
        ...
        <div class="topnav-right">            
            <a href="CustomerQuotation.php"><img src="img/add_doc_2.png" width="30px" height="30px" /> </a>
                ...
                if (temp["status"] == 'success') {
                    if (temp["form"] == 'SearchData') {
                        ...
                        for (var i = 0; i < temp["rCnt"]; i++) {
                                    Str += '<a class="list-group-item list-group-item-action" href="Quotation_DocNo.php?DocNo='+temp[i]["DocNo"]+'&add=1">' +

                                                '<div class="card"' +
                                                    '<div class="card-body">' +
                                                        '<h5 class="card-title label1">เลขที่เอกสาร : '+temp[i]["DocNo"]+
                                                        '<p class="card-text label2">ชื่อลูกค้า : '+temp[i]["Item"]+'</p>'+
                                                        '<p class="card-text label2">ลงเวลา : '+temp[i]["Modify_Date"]+'</p>'+
