 ...
 <script type="text/javascript">
  ...
  <style media="screen">
	...
	<table style="background: rgba(255,255,255,0.3);" width="100%" border="0" cellspacing="5" cellpadding="5">
              ...
              <tr>
                    <td>
                        <div align="center"><h2>ข้อมูลการขาย</h2></div>
                    </td>
                </tr>
              <tr>
                <td>
					<form action="Saledetail.php" method="get" name="Formsubmit">
                        <div data-demo-html="true">
            ...
            <td colspan="2">
              <table class="opacitysale" width="100%" border="1" cellspacing="0" cellpadding="0" >
                ...
                if(isset($_GET["month"])){
                  ...
                  $sql = "SELECT Sale_Code,Price,mm,yyyy FROM sale_income WHERE Sale_Code = '$Em_Code' AND mm = '$mm' AND yyyy = '$yy' ";
