...
<body>
	<div class="topnav">
          ...
          <div class="xlabel"><?= $Area ?> : Cyclic purchasing ( ALL )</div>
    ...
    <div class="xTop1">
  		<form action="chkDate04.php" method="post">
			...
			<div class="input-group mb-3">
				<span class="input-group-text xBoxWh">จังหวัด</span>
				<select name="xPv" id="xPv" class="form-select" aria-label="Default select example">
