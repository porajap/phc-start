...
<body>
	<div class="topnav">
        ...
        <div class="topnav-right">            
            <a href="CustomerDispenser.php"><img src="img/add_doc_2.png" width="30px" height="30px" /> </a>
                ...
                if (temp["status"] == 'success') {
                    if (temp["form"] == 'SearchData') {
                        ...
                        for (var i = 0; i < temp["rCnt"]; i++) {
                                    Str += '<a class="list-group-item list-group-item-action" href="Dispenser_DocNo.php?DocNo='+temp[i]["DocNo"]+'&add=1">' +
                                                // '<div class="row align-items-start xTb">' +
                                                //         '<div class="col">' +
                                                //             '<img src="img/unsuccess-1.png" width="25" height="25" /> เบิกครั้งที่ 1' +
                                                //         '</div>' +
                                                //         '<div class="col">' +
                                                //             '<img src="img/unsuccess-1.png" width="25" height="25" /> เบิกครั้งที่ 2' +
                                                //         '</div>' +
                                                //         '<div class="col">' +
                                                //             '<img src="img/unsuccess-1.png" width="25" height="25" /> เบิกครั้งที่ 3' +
                                                //         '</div>' +
                                                // '</div>' +
                                                '<div class="card"' +
                                                    '<div class="card-body">' +
