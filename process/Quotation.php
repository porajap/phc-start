<?php
  ...
  date_default_timezone_set("Asia/Bangkok");
	...
	function SearchData($conn,$DATA){
		...
		$Sql = "SELECT DocDate,DocNo,DueDate,IsSave,IsFinish,IsCancel,IsSend,customer.Cus_Code,'' AS Modify_Date,customer.FName ";
		...
		while ($Result = mysqli_fetch_assoc($meQuery)) {
			...
			$return[$count]['Modify_Date']	= $Result['DocDate'];
