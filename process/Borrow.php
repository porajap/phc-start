<?php
  ...
  date_default_timezone_set("Asia/Bangkok");
	...
	function SearchData($conn,$DATA){
		...
		$Sql = "SELECT DocDate,DocNo,DueDate,IsSave,IsFinish,IsCancel,IsSend,Cus_Code,DATE_FORMAT(DocDate,'%Y-%m-%d') AS DocDate,'-' AS Modify_Date ";
		$Sql .= "FROM borrow ";
		//$Sql .= "WHERE saleorder.DocDate BETWEEN '$sDate1' AND '$eDate1' ";
		$Sql .= "WHERE Area_Code = '$Area'  AND IsCancel = 0 AND DocNo LIKE '%$Search%'";
		if($lenSearch > 0)
