<?php
  ...
  function LoadAddress($conn,$DATA){
    ...
    $count = 0;
    $Sql = "SELECT id,ssName,ssLocation,ssAddress1,ssAddress2 FROM bring_address WHERE AreaCode = '$AreaCode' AND CusCode = '$CusCode' ORDER BY id DESC";
  ...
  function getAddress($conn,$DATA){
    ...
    $count = 0;
    $Sql = "SELECT id,ssName,ssLocation,ssAddress1,ssAddress2 FROM bring_address WHERE id = $id";
