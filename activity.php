...
$n = 0;
			if($IsStatus == 1){
				$xID = $_REQUEST["xID"];
				$Sql = "DELETE FROM activity_by_month ";
				$Sql .= "WHERE ID = '$xID'";
...
<body>
    <div class="topnav">
        <a href="p2_1.php"><img src="img/left-blue-arrow.png" width="30px" height="30px" /></a>
    ...
    <div>
      <div align="center" class="xTb">กิจกรรมที่ทำภายในเดือน</div>                                                      
    </div>

    <form method="post" action="Save_Activity.php" enctype="multipart/form-data" data-ajax="false">
    ...
    <table class="tables">
      ...
      <tbody>
        ...
        ?>               
                  <tr>
                    <th>
                      <a href="activity.php?IsStatus=1&xID=<?php echo $Result["ID"] ?>" ><img src="img/del.png" width="16" height="16" /></a>
                    </th>
                    <td><?php echo $Result["Activity"] ?></td>
                    <td><img src="<?php echo "img_a/" . $Result["Pic1"] ?>" width="100px"></td>
                    <td><img src="<?php echo "img_a/" . $Result["Pic2"] ?>" width="100px"></td>
                    <td><img src="<?php echo "img_a/" . $Result["Pic3"] ?>" width="100px"></td>
                    <td><img src="<?php echo "img_a/" . $Result["Pic4"] ?>" width="100px"></td>
                    <td><img src="<?php echo "img_a/" . $Result["Pic5"] ?>" width="100px"></td>
                  </tr>
        <?php $j++; } ?>
      </tbody>
      <tfoot>
