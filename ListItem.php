...
<body>
		<div data-demo-html="true">
			<div data-role="header">
            	<a href="ListHospital.php" class="ui-btn ui-btn-b ui-corner-all ui-btn-inline ui-mini footer-button-left ui-btn-icon-left ui-icon-carat-l">กลับ</a>
              ...
              <tr>
                ...
                <div data-demo-html="true">
                    <ul data-role="listview" data-filter="true" data-filter-placeholder="Search fruits..." data-inset="true">
                        ...
                        ?>
                          	<li>
                          		<a href="Save_Area_Note_Item.php?ICode=<?php echo $objResult2["Item_Code"];?>&IName=<?php echo $objResult2["NameTH"];?>"><h3><?php echo $objResult2["Item_Code"] ?> : <?php echo $objResult2["NameTH"];?></h3></a>  
                            </li>
                        <?php
                        }
                        ?>
