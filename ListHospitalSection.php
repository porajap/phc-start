...
require 'connect.php';
	...
	$Id = $_REQUEST["Id"];
	if($Id != ""){
		$Sql = "DELETE FROM hospital_section WHERE Section_ID = " . $Id;
...
<body>
		<div data-demo-html="true">
			<div data-role="header">
            	<a href=" <?php echo $BB ?>" class="ui-btn ui-corner-all ui-btn-inline ui-mini footer-button-left ui-btn-icon-left ui-icon-carat-l">กลับ</a>
	...
	<table width="100%" border="0" cellspacing="5" cellpadding="5">
              ...
              <tr>
                ...
                <form action="Save_Hospital_Section.php" method="post">
                        <label>รายชื่อแผนก/ผู้ติดต่อ</label>
                        <input type="text" name="HSection" id="HSection" placeholder="ป้อนรายชื่อผู้ติดต่อ/แผนก" value="">
              	...
              	<td>
                					<div data-demo-html="true">
                                        <ul data-role="listview" data-inset="true">
                                            ...
                                            <?
                                            $strSQL2 = "SELECT hospital_section.Section_ID,hospital_section.Hospital_Section FROM hospital_section ";
											$strSQL2 .= "WHERE hospital_section.Hospital_Code = " . $HCode;
                                            //echo $strSQL2;
                                            ...
                                            ?>
                                                ...
                                                href="ListHospitalSection.php?Id=<?php echo$objResult2["Section_ID"] ?>"> <?php echo$objResult2["Section_ID"] ?> : <?php echo$objResult2["Hospital_Section"];?> </a>
                                                </li>
                                            <?
                                            }
                                            ?>
