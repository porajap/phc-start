...
if( $_REQUEST["add"]== 0){
	...
	if($_REQUEST["add"] != "" ) $_SESSION["add"] = $_REQUEST["add"];	
}
...
//echo "2 : ".$_SESSION["DocNo"]."<br>";
			...
			$Sql = "SELECT DocNo,IsFinish,IsCancel,Detail,IsPO,IsQT,IsBV,IsST,customer.Cus_Code,CONCAT(customer.FName,' ',customer.LName) AS xName,tDate ";
			$Sql .= "FROM saleorder ";
                ...
                <tr>
                    ...
                    <form action="OrderDocFinish.php" method="post">
						...
						<div class="input-group mb-3">
							...
							<input type="text" name="tDate" id="tDate"  class="form-control" placeholder="xx/xx/xxxx" aria-describedby="basic-addon1" value="<?php echo $tDate ?>">
						</div>
						<div class="input-group mb-3">
