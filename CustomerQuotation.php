...
require 'connect.php';
	...
	// 	$Sql = "SELECT FName,LName FROM customer WHERE Cus_Code = '$CusCode' AND IsActive = 1";
	...
	// 		$i=1;
	// 	}
	// 	if( $i==1 ) header('location:Quotation_DocNo.php');
	// }
                ...
                if (temp["status"] == 'success') {
                    if (temp["form"] == 'SearchData') {
						...
						for (var i = 0; i < temp["rCnt"]; i++) {
									link="Quotation_DocNo.php?add=0&Cus_Code="+temp[i]["Cus_Code"];
