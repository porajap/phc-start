...
<body>
  ...
  <div>
      <div align="center" class="xTb">บันทึกสินค้าเข้าใหม่ ( เดือนปัจจุบัน )</div> 
...
<?php 	
				...
				$Sql .= "WHERE Area = '$Area' AND YY = '$yy' AND MM = '$mm' AND xMM = '$mm'";
          ...
          <tr>
            <th>
              <a href="ProductNew.php?IsStatus=1&xID=<?php echo $Result["ID"] ?>" ><img src="img/del.png" width="16" height="16" /></a>
              <?php echo $j+1 ?>
            </th>
