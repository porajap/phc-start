...
date_default_timezone_set("Asia/Bangkok");
	...
	$Sql .= "FROM bring ";
	//$Sql .= "WHERE bring.DocDate BETWEEN '$sDate1' AND '$eDate1' ";
	$Sql .= "WHERE bring.Area_Code = '$Area'  AND bring.IsCancel = 0 ";
...
<body>
		<div data-demo-html="true">
			<div data-role="header">
            	<a href="Bring.php" class="ui-btn ui-corner-all ui-btn-inline ui-mini footer-button-left ui-btn-icon-left ui-icon-carat-l">กลับ</a>
...
<?php 	for($j=0;$j<$i;$j++){ ?>
					<li>
                    <a href="Bring_DocNo.php?add=1&DocNo=<?php echo $xDocNo[$j] ?>">
                            <?php      
