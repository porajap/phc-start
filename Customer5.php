...
require 'connect.php';
	...
	if($_REQUEST["Id"] != ""){
		...
		header('location:Quotation_DocNo.php?add=0&sel=0');
	}
...
<body>
		<div data-demo-html="true">
			<div data-role="header">
            	<a href="CustomerQuotation.php" class="ui-btn ui-corner-all ui-btn-inline ui-mini footer-button-left ui-btn-icon-left ui-icon-carat-l">กลับ</a>
    ...
    <?php 	
        ...
        {
    ?>
                        <li><a href="Customer2.php?Id=<?php echo $Result["Cus_Code"] ?>"><?php echo $Result["Cus_Code"] . " : " .$Result["FName"] . "  " . $Result["LName"] ?></a></li>
    <?php } ?>
                    </ul>
                </div>
                    </td>
 			...
 			<div data-demo-html="true">
				<ul data-role="listview" data-filter="true" data-filter-placeholder="Search fruits..." data-inset="true">
<?php 	
	$Sql = "SELECT Cus_Code,FName,LName FROM customer WHERE AreaCode = '$Area'";
