...
<body>
	<div class="topnav">
        <a href="Bring_DocNo.php"><img src="img/left-blue-arrow.png" width="30px" height="30px" /></a>
	...
	<form action="BringPriceSale.php" method="post">
		<div class="row xTop1">
			<div class="col">
 ...
 <?php 	for($j=0;$j<$i;$j++){ ?>               
                  <tr>
                    <th><?php echo $j+1 ?></th>
                    <td><a href="BringQty.php?ItemCode=<?php echo $Item_Code[$j] ?>&Price=<?php echo $xPrice[$j] ?>"><?php echo $NameTH[$j] ?></a></td>
