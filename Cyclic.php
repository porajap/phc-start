	...
	for($i=$sYear;$i<=$eYear;$i++){
		for($j=1;$j<=12;$j++){
			$Sql= "SELECT " .
					 ...
					 "AND customer.Prefix_Code = $xGP " .
					 "AND th_amphur.Pv_Code LIKE '$xPv%' " .
					 "AND item.CategorySub_Code LIKE '16%' " .
					 "AND item.Grp_1 = 1 " .
			...
			for($g=0;$g<$n;$g++){
							//echo "<input type='text' value='$i:$xCusCode[$g]:$xItemCode[$g]' />";
							if(getText($i,$xCusCode[$g],$xItemCode[$g],$xPv,$EmCode) == 0)	{
...
?>
		...
		<div data-demo-html="true">
			<div data-role="header">
                <a href="Date05.php" class="ui-btn ui-corner-all ui-btn-inline ui-mini footer-button-left ui-btn-icon-left ui-icon-carat-l">กลับ</a>
         ...
         <div data-demo-html="true">
			...
			<table border="0" cellspacing="0" cellpadding="0">
                ...
                <thead>
                  ...
                  <tr>
                    <th style="background-image: url(img/Line04.png);" height="29px" width="120px" align="center" data-priority="1">1</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="2">2</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="3">3</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="6">4</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="6">5</th>
					<th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="6"> 6</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="6">7</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="6">8</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="6">9</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="6">10</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="6">11</th>
                    <th style="background-image: url(img/Line04.png);" width="120px" align="center" data-priority="6">12</th>
                  </tr>                  
                </thead>
                <tbody>
 ...
 <?php 	
			...
			for($j=0;$j<$n;$j++){   
					...
					if($xItemName[($j)] == $xItemName[($j+1)]){ 
						echo "<td width='250px' rowspan='2'>$xItemName[$j]</td>";
						echo "<td width='50px' rowspan='2' align='center'>$nYear[$j]</td>";
					}else{
						echo "<td style='background-image: url(img/Line02.png);'  rowspan='2'>$xItemName[$j]</td>";
						echo "<td style='background-image: url(img/Line02.png);' width='50px' rowspan='2' align='center'>$nYear[$j]</td>";						
					}
				  		//===== M1 =====
				  		if( ($gY == $nYear[$j]) &&  (intval($gM) == 1) )
							echo "<td style='background-image: url(img/Line03.png);' height='30px' align='center'>$xM1[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' height='30px' align='center'>$xM1[$j]</td>";
						//===== M2 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 2) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM2[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM2[$j]</td>";
						//===== M3 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 3) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM3[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM3[$j]</td>";
						//===== M4 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 4) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM4[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM4[$j]</td>";	
						//===== M5 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 5) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM5[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM5[$j]</td>";		
						//===== M6 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 6) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM6[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM6[$j]</td>";		
						//===== M7 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 7) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM7[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM7[$j]</td>";	
						//===== M8 =====	
						...
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 9) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM9[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM9[$j]</td>";	
						//===== M10 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 10) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM10[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM10[$j]</td>";		
						//===== M11 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 11) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM11[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM11[$j]</td>";	
						//===== M12 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 12) )
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM12[$j]</td>";
						else
							echo "<td style='background-image: url(img/Line03.png);' align='center'>$xM12[$j]</td>";
					?>
                  </tr>
                  ...
                  <?php
				  		//===== B1 =====
				  		if( ($gY == $nYear[$j]) &&  (intval($gM) == 1) )
							echo "<td style='background-image: url(img/Line05.png);' height='30px' align='center'>( $xB1[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' height='30px' align='center'>( $xB1[$j] )</td>";
						//===== B2 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 2) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB2[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB2[$j] )</td>";
						//===== B3 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 3) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB3[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB3[$j] )</td>";
						//===== B4 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 4) )
							echo "<td style='background-image: url(img/Line05.png);'align='center'>( $xB4[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB4[$j] )</td>";	
						//===== B5 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 5) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB5[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB5[$j] )</td>";		
						//===== B6 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 6) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB6[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB6[$j] )</td>";		
						//===== B7 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 7) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB7[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB7[$j] )</td>";	
						//===== B8 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 8) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB8[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB8[$j] )</td>";		
						//===== B9 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 9) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB9[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB9[$j] )</td>";	
						//===== B10 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 10) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB10[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB10[$j] )</td>";		
						//===== B11 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 11) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB11[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB11[$j] )</td>";	
						//===== B12 =====	
						if( ($gY == $nYear[$j]) &&  (intval($gM) == 12) )
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB12[$j] )</td>";
						else
							echo "<td style='background-image: url(img/Line05.png);' align='center'>( $xB12[$j] )</td>";
                    ?>
                  </tr>
