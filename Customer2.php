...
<body>
	<div class="topnav">
        <a href="order.php"><img src="img/left-blue-arrow.png" width="30px" height="30px" /></a>
                ...
                if (temp["status"] == 'success') {
                    if (temp["form"] == 'SearchData') {
						...
						for (var i = 0; i < temp["rCnt"]; i++) {
									...
									switch(temp["xMenu"]){
										case 1: link="Order_DocNo.php?&add="+temp["xAdd"]+"&Cus_Code="+temp[i]["Cus_Code"];break;
									}
