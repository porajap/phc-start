...
<body>
	<div class="topnav">
        ...
        <div class="topnav-right">            
            <a href="Customer2.php?add=0"><img src="img/add_doc_2.png" width="30px" height="30px" /> </a>
                ...
                if (temp["status"] == 'success') {
                    if (temp["form"] == 'SearchData') {
                        ...
                        for (var i = 0; i < temp["rCnt"]; i++) {
                                    Str += '<a class="list-group-item list-group-item-action" href="Order_DocNo.php?DocNo='+temp[i]["DocNo"]+'&add=1">' +
                                                '<div class="card"' +
                                                    '<div class="card-body">' +
